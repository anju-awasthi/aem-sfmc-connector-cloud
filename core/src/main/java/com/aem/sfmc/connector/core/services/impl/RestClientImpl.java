...
public class RestClientImpl implements RestClient {
    ...
    @Reference
    private SFMCConnectorConfigService configService;
    ...
    public final APIResponse sendRequest(final BaseRequest request, final Map<String, String> headerMap) throws IOException, MethodNotSupportedException {
        ...
        long lStartTime = SFMCConnectorUtil.getStartTime();
        ...
        try {
            ...
            LOG.debug(TOTAL_TIME_TAKEN_FOR_API_REQUEST_MS, SFMCConnectorUtil.logMethodTime(lStartTime));
    ...
    public void activate() {
        ...
        try {
            ...
            Registry<ConnectionSocketFactory> socketFactoryRegistry = RegistryBuilder.<ConnectionSocketFactory>create()
                    .register(SFMCConnectorConstants.HTTPS, sslsf)
                    .register(SFMCConnectorConstants.HTTP, new PlainConnectionSocketFactory()).build();
            // NOSONAR
